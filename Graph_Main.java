...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create_Metro_Map(Graph_Main g)
		{
			g.addVertex("Airport");
			g.addVertex("Meenambakkam");
			g.addVertex("Naganallur");
			g.addVertex("Alandur");
			g.addVertex("Guindy");
			g.addVertex("Little_Mount");
			...
			g.addVertex("Shenday Nagar");
			g.addVertex("Pachaiyapass College");
			g.addVertex("Kilapuk");
			g.addVertex("Nehru Park");
			g.addVertex("Egmore Metro");
			
			g.addEdge("Airport", "Meenambakkam", 2500);
			g.addEdge("Meenambakkam", "Naganallur", 2200);
			g.addEdge("Naganallur", "Alandur", 1800);
			g.addEdge("Alandur", "Guindy", 5600);
			g.addEdge("Guindy", "Little_Mount", 3700);
			g.addEdge("Little_Mount", "Saidapet", 1100);
			g.addEdge("Saidapet", "Nandanam", 2800);
			g.addEdge("Nandanam", "Teynampet", 2900);
			g.addEdge("Teynampet", "AG-DMS", 750);
			g.addEdge("AG-DMS", "Thousand Lights", 3100);
			g.addEdge("Thousand Lights", "LIC", 2200);
			g.addEdge("LIC", "Government Estate", 2100);
			g.addEdge("Government Estate", "Central", 2200);
			g.addEdge("Central", "High Court", 1900);
			g.addEdge("High Court", "Mannadi", 1100);
			g.addEdge("Mannadi", "Washaermrnpet", 2900);
			g.addEdge("St. Thomas Mount", "Alandur", 1600);
			g.addEdge("Alandur", "Ekkattuthangal", 3400);
			g.addEdge("Ashok Nagar", "Vadapalam", 1900);
			g.addEdge("Vadapalam", "Arumbakkam", 1600);
			g.addEdge("Arumbakkam", "CMBT", 2200);
			g.addEdge("CMBT", "Koyambedu", 2700);
			g.addEdge("Koyambedu", "Thirumangalam", 4200);
			g.addEdge("Thirumangalam", "Anna Nagar Tower", 800);
			g.addEdge("Anna Nagar Tower", "Anna Nagar East", 1300);
			g.addEdge("Anna Nagar East", "Shenday Nagar", 1700);
			g.addEdge("Shenday Nagar", "Pachaiyapass College", 1400);
			g.addEdge("Pachaiyapass College", "Kilapuk", 1300);
			g.addEdge("Kilapuk", "Nehru Park", 850);
			g.addEdge("Nehru Park", "Egmore Metro", 1400);
			g.addEdge("Egmore Metro", "Central", 3100);
		}
		...
		{
			Graph_Main g = new Graph_Main();
			Create_Metro_Map(g);
			
			System.out.println("\n\t\t\t****WELCOME TO THE CHENNAI METRO*****");
			...
			while(true)
			{
				...
				case 3:
					...
					System.out.println("SHORTEST DISTANCE FROM "+st1+" TO "+st2+" IS "+g.dijkstra(st1, st2, false)+"Meters\n");
					break;
